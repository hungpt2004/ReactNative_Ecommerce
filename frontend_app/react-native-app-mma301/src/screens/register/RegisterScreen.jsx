      ...
      <View style={styles.container}>
         ...
         <View style={styles.buttonContainer}>
            <TouchableOpacity style={[styles.button, styles.loginButton]}>
               <Text style={styles.buttonText} onPress={() => handleSignIn()}>Sign Up</Text>

            </TouchableOpacity>
         </View>
         {/* Signup Text */}
         <View style={styles.signupContainer}>
            <Text style={styles.signupText1}>Already have an account? <Text onPress={() => navigation.navigate('login')} style={styles.signupText}>Sign In</Text></Text>
         </View>
      </View>
   )
}
